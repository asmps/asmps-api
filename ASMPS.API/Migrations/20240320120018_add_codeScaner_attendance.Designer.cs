...
namespace ASMPS.API.Migrations
{
    ...
    [Migration("20240320120018_add_codeScaner_attendance")]
    partial class add_codeScaner_attendance
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ASMPS.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b7f0a3bb-a52f-49d4-8a35-3a1f36c55b4f"),
                            CreatedDate = new DateTime(2024, 3, 20, 12, 0, 17, 864, DateTimeKind.Utc).AddTicks(5991),
