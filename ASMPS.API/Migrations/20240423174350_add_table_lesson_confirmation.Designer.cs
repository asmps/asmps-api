...
namespace ASMPS.API.Migrations
{
    ...
    [Migration("20240423174350_add_table_lesson_confirmation")]
    partial class add_table_lesson_confirmation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ASMPS.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7229925f-4440-4407-89ea-dd610eba2e0e"),
                            CreatedDate = new DateTime(2024, 4, 23, 17, 43, 50, 266, DateTimeKind.Utc).AddTicks(41),
