...
namespace ASMPS.API.Migrations
{
    ...
    [Migration("20240320121552_updateCodeScanner_addScanner")]
    partial class updateCodeScanner_addScanner
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ASMPS.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("048f1381-d85a-4cd5-a982-61e65f4909c6"),
                            CreatedDate = new DateTime(2024, 3, 20, 12, 15, 51, 882, DateTimeKind.Utc).AddTicks(7361),
