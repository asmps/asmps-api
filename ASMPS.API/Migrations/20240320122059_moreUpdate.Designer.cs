...
namespace ASMPS.API.Migrations
{
    ...
    [Migration("20240320122059_moreUpdate")]
            ...
            modelBuilder.Entity("ASMPS.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("22c25715-2974-4fa6-bcce-3ec0eebeb670"),
                            CreatedDate = new DateTime(2024, 3, 20, 12, 20, 59, 621, DateTimeKind.Utc).AddTicks(9602),
