...
namespace ASMPS.API.Migrations
{
    ...
    [Migration("20240307115800_add_deanery")]
    partial class add_deanery
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ASMPS.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8c5e69a0-df44-404c-97b3-ac860dacde70"),
                            CreatedDate = new DateTime(2024, 3, 7, 11, 58, 0, 397, DateTimeKind.Utc).AddTicks(6411),
