...
namespace ASMPS.API.Migrations
{
    ...
    [Migration("20240612131242_last_version")]
            ...
            modelBuilder.Entity("ASMPS.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8bb5cfa3-9e56-4b44-8c44-f42101235ac7"),
                            CreatedDate = new DateTime(2024, 6, 12, 13, 12, 41, 818, DateTimeKind.Utc).AddTicks(7094),
