...
namespace ASMPS.API.Migrations
{
    ...
    [Migration("20240307121322_editContext_addModels")]
    partial class editContext_addModels
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ASMPS.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("441ac88b-891e-4d9f-ab75-2106a36dcfcf"),
                            CreatedDate = new DateTime(2024, 3, 7, 12, 13, 22, 457, DateTimeKind.Utc).AddTicks(9027),
