...
namespace ASMPS.API.Migrations
{
    ...
    [Migration("20240307112722_add_campus_audience")]
    partial class add_campus_audience
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ASMPS.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3b9350ff-38b3-4146-a2ac-978a74ecbcfd"),
                            CreatedDate = new DateTime(2024, 3, 7, 11, 27, 22, 664, DateTimeKind.Utc).AddTicks(8522),
